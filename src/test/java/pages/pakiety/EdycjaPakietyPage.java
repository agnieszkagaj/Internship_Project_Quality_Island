...
public class EdycjaPakietyPage {
    ...
    public boolean zwrocUrlAktualnejStronyEdycjaPakietu(){
        System.out.println("Adres strony 'Edycja pakietu' jest poprawny, status: " + driver.getCurrentUrl().contains("//anonim.adresurl.onl/" ));
        return driver.getCurrentUrl().contains("//anonim.adresurl.onl/");
    }
