...
public class EdycjaUslugiPage {
    ...
    private final String poprawnyURLStronyEdycjaUslugi = "https://anonim.adresurl.onl/wp-admin/admin.php?page=anonim-adresurl-editor-service&edit_service_id=1205&autofocus=general";
