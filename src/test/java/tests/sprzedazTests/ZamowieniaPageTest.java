...
public class ZamowieniaPageTest extends TestBase {
    ...
    public void weryfikacja() {
        ...
        driver.get("https://anonim.adresurl.onl/wp-admin/options.php?page=edd-manual-purchase");
        ...
        driver.get("https://anonim.adresurl.onl/wp-admin/admin.php?page=wp-idea-payment-history");
